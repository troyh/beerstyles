...
[
   ...
   
		{
			...
			"impression": """Refreshing and thirst quenching, although generally more filling than standard/lite versions."""
   ...
   
		{
			...
			"impression": """Balance and smoothness are the hallmarks of this style.  It has the malt profile of a Helles, the hop character of a Pils, and is slightly stronger than both."""
   ...
   
		{
			...
			"impression": """Crisp, clean, refreshing beer that prominently features noble German hop bitterness accentuated by sulfates in the water."""
   ...
   
		{
			...
			"impression": """Characterized by soft, elegant maltiness that dries out in the finish to avoid becoming sweet."""
   ...
   
		{
			...
			"impression": """Smooth, clean, and rather rich, with a depth of malt character.  This is one of the classic malty styles, with a maltiness that is often described as soft, complex, and elegant but never cloying."""
   ...
   
		{
			...
			"impression": """A somewhat sweeter version of standard/premium lager with a little more body and flavor."""
   ...
   
		{
			...
			"impression": """Characterized by depth and complexity of Munich malt and the accompanying melanoidins.  Rich Munich flavors, but not as intense as a bock or as roasted as a schwarzbier."""
			...
			"examples": """Ayinger Altbairisch Dunkel, Hacker-Pschorr Alt Munich Dark, Paulaner Alt Münchner Dunkel, Weltenburger Kloster Barock-Dunkel, Ettaler Kloster Dunkel, Hofbräu Dunkel, Penn Dark Lager, König Ludwig Dunkel, Capital Munich Dark, Harpoon Munich-type Dark Beer, Gordon Biersch Dunkels, Dinkel Acker Dark.  In Bavaria, Ettaler Dunkel, Löwenbräu Dunkel, Hartmann Dunkel, Kneitinger Dunkel, Augustiner Dunkel."""
		}
   ...
   
		{
			...
			"impression": """A dark German lager that balances roasted yet smooth malt flavors with moderate hop bitterness."""
   ...
   
		{
			...
			"impression": """A relatively pale, strong, malty lager beer.  Designed to walk a fine line between blandness and too much color.  Hop character is generally more apparent than in other bocks."""
   ...
   
		{
			...
			"impression": """A very strong and rich lager.  A bigger version of either a traditional bock or a helles bock."""
			...
			"examples": """Paulaner Salvator, Ayinger Celebrator, Weihenstephaner Korbinian, Andechser Doppelbock Dunkel, Spaten Optimator, Tucher Bajuvator, Weltenburger Kloster Asam-Bock, Capital Autumnal Fire, EKU 28, Eggenberg Urbock 23°, Bell's Consecrator, Moretti La Rossa, Samuel Adams Double Bock"""
		}
   ...
   
		{
			...
			"impression": """A clean, well-attenuated, flavorful American lawnmower beer."""
   ...
   
		{
			...
			"impression": """Easy-drinking, approachable, malt-oriented American craft beer."""
   ...
   
		{
			...
			"impression": """A clean, crisp, delicately balanced beer usually with very subtle fruit flavors and aromas.  Subdued maltiness throughout leads to a pleasantly refreshing tang in the finish.  To the untrained taster easily mistaken for a light lager, a somewhat subtle Pilsner, or perhaps a blonde ale."""
   ...
   
		{
			...
			"impression": """A very clean and relatively bitter beer, balanced by some malt character.  Generally darker, sometimes more caramelly, and usually sweeter and less bitter than Düsseldorf Altbier."""
   ...
   
		{
			...
			"impression": """A lightly fruity beer with firm, grainy maltiness, interesting toasty and caramel flavors, and showcasing the signature Northern Brewer varietal hop character."""
   ...
   
		{
			...
			"impression": """A well balanced, bitter yet malty, clean, smooth, well-attenuated amber-colored German ale."""
   ...
   
		{
			...
			"ingredients": """Pale ale, amber, and/or crystal malts, may use a touch of black malt for color adjustment.  May use sugar adjuncts, corn or wheat.  English hops most typical, although American and European varieties are becoming more common (particularly in the paler examples).  Characterful English yeast.  Often medium sulfate water is used."""
			"examples": """Fuller's London Pride, Coniston Bluebird Bitter, Timothy Taylor Landlord, Adnams SSB, Young's Special, Shepherd Neame Masterbrew Bitter, Greene King Ruddles County Bitter, RCH Pitchfork Rebellious Bitter, Brains SA, Black Sheep Best Bitter, Goose Island Honkers Ale, Rogue Younger's Special Bitter"""
		}
   ...
   
		{
			...
			"impression": """Cleanly malty with a drying finish, perhaps a few esters, and on occasion a faint bit of peaty earthiness (smoke).  Most beers finish fairly dry considering their relatively sweet palate, and as such have a different balance than strong Scotch ales."""
   ...
   
		{
			...
			"comments": """The malt-hop balance is slightly to moderately tilted towards the malt side. Any caramelization comes from kettle caramelization and not caramel malt (and is sometimes confused with diacetyl).  Although unusual, any smoked character is yeast- or water-derived and not from the use of peat-smoked malts.  Use of peat-smoked malt to replicate the peaty character should be restrained; overly smoky beers should be entered in the Other Smoked Beer category (22B) rather than here.  """
			"ingredients": """Scottish or English pale base malt. Small amounts of roasted barley add color and flavor, and lend a dry, slightly roasty finish. English hops. Clean, relatively un-attenuative ale yeast. Some commercial brewers add small amounts of crystal, amber, or wheat malts, and adjuncts such as sugar.  The optional peaty, earthy and/or smoky character comes from the traditional yeast and from the local malt and water rather than using smoked malts."""
			"examples": """Orkney Dark Island, Caledonian 80/- Export Ale, Belhaven 80/- (Belhaven Scottish Ale in the US), Southampton 80 Shilling, Broughton Exciseman's 80/-, Belhaven St. Andrews Ale, McEwan's Export (IPA), Inveralmond Lia Fail, Broughton Merlin's Ale, Arran Dark"""
		}
   ...
   
		{
			...
			"impression": """An easy-drinking pint.  Malt-focused with an initial sweetness and a roasted dryness in the finish."""
			...
			"examples": """Three Floyds Brian Boru Old Irish Ale, Great Lakes Conway's Irish Ale (a bit strong at 6.5%), Kilkenny Irish Beer, O'Hara's Irish Red Ale, Smithwick's Irish Ale, Beamish Red Ale, Caffrey's Irish Ale, Goose Island Kilgubbin Red Ale, Murphy's Irish Red (lager), Boulevard Irish Ale, Harpoon Hibernian Ale"""
		}
   ...
   
		{
			...
			"impression": """Rich, malty and usually sweet, which can be suggestive of a dessert. Complex secondary malt flavors prevent a one-dimensional impression.  Strength and maltiness can vary."""
   ...
   
		{
			...
			"impression": """Refreshing and hoppy, yet with sufficient supporting malt."""
   ...
   
		{
			...
			"impression": """Like an American pale ale with more body, more caramel richness, and a balance more towards malt than hops (although hop rates can be significant)."""
			...
			"examples": """North Coast Red Seal Ale, Tröegs HopBack Amber Ale, Deschutes Cinder Cone Red, Pyramid Broken Rake, St. Rogue Red Ale, Anderson Valley Boont Amber Ale, Lagunitas Censored Ale, Avery Redpoint Ale, McNeill's Firehouse Amber Ale, Mendocino Red Tail Ale, Bell's Amber"""
		}
   ...
   
		{
			...
			"impression": """Can be considered a bigger, maltier, hoppier interpretation of Northern English brown ale or a hoppier, less malty Brown Porter, often including the citrus-accented hop presence that is characteristic of American hop varieties."""
   ...
   
		{
			...
			"impression": """A light-flavored, malt-accented beer that is readily suited to drinking in quantity.  Refreshing, yet flavorful.  Some versions may seem like lower gravity brown porters."""
   ...
   
		{
			...
			"impression": """A luscious, malt-oriented brown ale, with a caramel, dark fruit complexity of malt flavor.  May seem somewhat like a smaller version of a sweet stout or a sweet version of a dark mild."""
   ...
   
		{
			...
			"impression": """Drier and more hop-oriented that southern English brown ale, with a nutty character rather than caramel."""
   ...
   
		{
			...
			"impression": """A fairly substantial English dark ale with restrained roasty characteristics."""
   ...
   
		{
			...
			"impression": """A substantial, malty dark ale with a complex and flavorful roasty character."""
   ...
   
		{
			...
			"impression": """A Baltic Porter often has the malt flavors reminiscent of an English brown porter and the restrained roast of a schwarzbier, but with a higher OG and alcohol content than either.  Very complex, with multi-layered flavors."""
   ...
   
		{
			...
			"examples": """Guinness Draught Stout (also canned), Murphy's Stout, Beamish Stout, O'Hara's Celtic Stout, Russian River O.V.L. Stout, Three Floyd's Black Sun Stout, Dorothy Goodbody's Wholesome Stout, Orkney Dragonhead Stout, Old Dominion Stout, Goose Island Dublin Stout, Brooklyn Dry Stout"""
		}
   ...
   
		{
			...
			"impression": """A very dark, sweet, full-bodied, slightly roasty ale.  Often tastes like sweetened espresso."""
   ...
   
		{
			...
			"impression": """A very dark, full-bodied, roasty, malty ale with a complementary oatmeal flavor."""
   ...
   
		{
			...
			"impression": """A very dark, moderately strong, roasty ale.  Tropical varieties can be quite sweet, while export versions can be drier and fairly robust."""
			...
			"examples": """Lion Stout (Sri Lanka), Dragon Stout (Jamaica), ABC Stout (Singapore), Royal Extra "The Lion Stout" (Trinidad), Jamaica Stout (Jamaica), Export-Type: Freeminer Deep Shaft Stout, Guinness Foreign Extra Stout (bottled, not sold in the US), Ridgeway of Oxfordshire Foreign Extra Stout, Coopers Best Extra Stout, Elysian Dragonstooth Stout"""
		}
   ...
   
		{
			...
			"impression": """A hoppy, bitter, strongly roasted Foreign-style Stout (of the export variety)."""
   ...
   
		{
			...
			"impression": """An intensely flavored, big, dark ale. Roasty, fruity, and bittersweet, with a noticeable alcohol presence. Dark fruit flavors meld with roasty, burnt, or almost tar-like sensations.  Like a black barleywine with every dimension of flavor coming into play."""
   ...
   
		{
			...
			"impression": """A hoppy, moderately strong pale ale that features characteristics consistent with the use of English malt, hops and yeast.  Has less hop character and a more pronounced malt flavor than American versions."""
			...
			"examples": """Meantime India Pale Ale, Freeminer Trafalgar IPA, Fuller's IPA, Ridgeway Bad Elf, Summit India Pale Ale, Samuel Smith's India Ale, Hampshire Pride of Romsey IPA, Burton Bridge Empire IPA,Middle Ages ImPailed Ale, Goose Island IPA, Brooklyn East India Pale Ale"""
		}
   ...
   
		{
			...
			"impression": """A decidedly hoppy and bitter, moderately strong American pale ale."""
			"comments": """"""
   ...
   
		{
			...
			"impression": """A pale, spicy, fruity, refreshing wheat-based ale."""
   ...
   
		{
			...
			"impression": """A moderately dark, spicy, fruity, malty, refreshing wheat-based ale.  Reflecting the best yeast and wheat character of a hefeweizen blended with the malty richness of a Munich dunkel."""
			...
			"examples": """Weihenstephaner Hefeweissbier Dunkel, Ayinger Ur-Weisse, Franziskaner Dunkel Hefe-Weisse, Schneider Weisse (Original), Ettaler Weissbier Dunkel, Hacker-Pschorr Weisse Dark, Tucher Dunkles Hefe Weizen, Edelweiss Dunkel Weissbier, Erdinger Weissbier Dunkel, Kapuziner Weissbier Schwarz"""
		}
   ...
   
		{
			...
			"impression": """A strong, malty, fruity, wheat-based ale combining the best flavors of a dunkelweizen and the rich strength and body of a bock."""
			...
			"examples": """Schneider Aventinus, Schneider Aventinus Eisbock, Plank Bavarian Dunkler Weizenbock, Plank Bavarian Heller Weizenbock, AleSmith Weizenbock, Erdinger Pikantus, Mahr's Der Weisse Bock, Victory Moonglow Weizenbock, High Point Ramstein Winter Wheat, Capital Weizen Doppelbock, Eisenbahn Vigorosa"""
		}
   ...
   
		{
			...
			"impression": """A dunkelweizen made with rye rather than wheat, but with a greater body and light finishing hops."""
   ...
   
		{
			...
			"impression": """A refreshing, elegant, tasty, moderate-strength wheat-based ale."""
   ...
   
		{
			...
			"impression": """A fruity, moderately malty, somewhat spicy, easy-drinking, copper-colored ale."""
   ...
   
		{
			...
			"impression": """A refreshing, medium to strong fruity/spicy ale with a distinctive yellow-orange color, highly carbonated, well hopped, and dry with a quenching acidity."""
			...
			"examples": """Saison Dupont Vieille Provision; Fantôme Saison D'Erezée - Printemps; Saison de Pipaix; Saison Regal; Saison Voisin; Lefebvre Saison 1900; Ellezelloise Saison 2000; Saison Silly; Southampton Saison; New Belgium Saison; Pizza Port SPF 45; Lost Abbey Red Barn Ale; Ommegang Hennepin"""
		}
   ...
   
		{
			...
			"impression": """A fairly strong, malt-accentuated, lagered artisanal farmhouse beer."""
   ...
   
		{
			...
			"impression": """Variable.  This category encompasses a wide range of Belgian ales produced by truly artisanal brewers more concerned with creating unique products than in increasing sales."""
...
The judges must understand the brewer's intent in order to properly judge an entry in this category.  THE BREWER MUST SPECIFY EITHER THE BEER BEING CLONED, THE NEW STYLE BEING PRODUCED OR THE SPECIAL INGREDIENTS OR PROCESSES USED.  Additional background information on the style and/or beer may be provided to judges to assist in the judging, including style parameters or detailed descriptions of the beer.  Beers fitting other Belgian categories should not be entered in this category."""
   ...
   
		{
			...
			"impression": """A very pale, sour, refreshing, low-alcohol wheat ale."""
   ...
   
		{
			...
			"impression": """A malty, fruity, aged, somewhat sour Belgian-style brown ale."""
   ...
   
		{
			...
			"impression": """Complex, sour/acidic, pale, wheat-based ale fermented by a variety of Belgian microbiota."""
   ...
   
		{
			...
			"impression": """Complex, pleasantly sour/acidic, balanced, pale, wheat-based ale fermented by a variety of Belgian microbiota."""
			...
			"ingredients": """Unmalted wheat (30-40%), Pilsner malt and aged (surannes) hops (3 years) are used.  The aged hops are used more for preservative effects than bitterness, and makes actual bitterness levels difficult to estimate.  Traditionally these beers are spontaneously fermented with naturally-occurring yeast and bacteria in predominately oaken barrels.  Home-brewed and craft-brewed versions are more typically made with pure cultures of yeast commonly including Saccharomyces, Brettanomyces, Pediococcus and Lactobacillus in an attempt to recreate the effects of the dominant microbiota of Brussels and the surrounding countryside of the Senne River valley.  Cultures taken from bottles are sometimes used but there is no simple way of knowing what organisms are still viable."""
			"examples": """Boon Oude Gueuze, Boon Oude Gueuze Mariage Parfait, De Cam Gueuze, De Cam/Drei Fonteinen Millennium Gueuze, Drie Fonteinen Oud Gueuze, Cantillon Gueuze, Hanssens Oude Gueuze, Lindemans Gueuze Cuvée René, Girardin Gueuze (Black Label), Mort Subite (Unfiltered) Gueuze, Oud Beersel Oude Gueuze"""
		}
   ...
   
		{
			...
			"mouthfeel": """Light to medium-light body.  In spite of the low finishing gravity, the many mouth-filling flavors prevent the beer from tasting like water.  Has a low to high tart, puckering quality without being sharply astringent.  Some versions have a low warming character.  Highly carbonated."""
			"impression": """Complex, fruity, pleasantly sour/acidic, balanced, pale, wheat-based ale fermented by a variety of Belgian microbiota.  A lambic with fruit, not just a fruit beer."""
   ...
   
		{
			...
			"impression": """A moderate-strength golden ale that has a subtle Belgian complexity, slightly sweet flavor, and dry finish.
"""
   ...
   
		{
			...
			"impression": """: A deep reddish, moderately strong, malty, complex Belgian ale."""
   ...
   
		{
			...
			"impression": """Strongly resembles a Strong Golden Ale but slightly darker and somewhat fuller-bodied.  Usually has a more rounded malt flavor but should not be sweet."""
   ...
   
		{
			...
			"impression": """A dark, very rich, complex, very strong Belgian ale.  Complex, rich, smooth and dangerous."""
   ...
   
		{
			...
			"impression": """A well-hopped American interpretation of the richest and strongest of the English ales.  The hop character should be evident throughout, but does not have to be unbalanced.  The alcohol strength and hop bitterness often combine to leave a very long finish."""
   ...
   
		{
			...
			"impression": """A harmonious marriage of fruit and beer.  The key attributes of the underlying style will be different with the addition of fruit; do not expect the base beer to taste the same as the unadulterated version.  Judge the beer based on the pleasantness and balance of the resulting combination."""
   ...
   
		{
			...
			"impression": """A stronger, darker, spiced beer that often has a rich body and warming finish suggesting a good accompaniment for the cold winter season."""
			...
			"examples": """Anchor Our Special Ale, Harpoon Winter Warmer, Weyerbacher Winter Ale, Nils Oscar Julöl, Goose Island Christmas Ale, North Coast Wintertime Ale, Great Lakes Christmas Ale, Lakefront Holiday Spice Lager Beer, Samuel Adams Winter Lager, Troegs The Mad Elf, Jamtlands Julöl"""
		}
   ...
   
		{
			...
			"impression": """Märzen/Oktoberfest-style (see 3B) beer with a sweet, smoky aroma and flavor and a somewhat darker color."""
...
Appearance: Variable.  The appearance should reflect the base beer style, although the color of the beer is often a bit darker than the plain base style."""
			...
			"impression": """This is any beer that is exhibiting smoke as a principle flavor and aroma characteristic other than the Bamberg-style Rauchbier (i.e., beechwood-smoked Märzen).  Balance in the use of smoke, hops and malt character is exhibited by the better examples."""
			...
			"examples": """Alaskan Smoked Porter, O'Fallons Smoked Porter, Spezial Lagerbier, Weissbier and Bockbier, Stone Smoked Porter, Schlenkerla Weizen Rauchbier and Ur-Bock Rauchbier, Rogue Smoke, Oskar Blues Old Chub, Left Hand Smoke Jumper, Dark Horse Fore Smoked Stout, Magic Hat Jinx"""
		}
   ...
   
		{
			...
			"impression": """In well-made examples of the style, the fruit is both distinctive and well-incorporated into the honey-sweet-acid-tannin-alcohol balance of the mead.  Different types of fruit can result in widely different characteristics; allow for a variation in the final product."""
			"comments": """"""
   ...
   
		{
			...
			"impression": """In well-made examples of the style, the herbs/spices are both distinctive and well-incorporated into the honey-sweet-acid-tannin-alcohol balance of the mead.  Different types of herbs/spices can result in widely different characteristics; allow for a variation in the final product."""
   ...
   
		{
			...
			"impression": """A harmonious blend of mead and beer, with the distinctive characteristics of both.  A wide range of results are possible, depending on the base style of beer, variety of honey and overall sweetness and strength.  Beer flavors tend to somewhat mask typical honey flavors found in other meads."""
   ...
   
		{
			...
			"impression": """Variable, but should be a medium, refreshing drink. Sweet ciders must not be cloying. Dry ciders must not be too austere. An ideal cider serves well as a "session" drink, and suitably accompanies a wide variety of food."""
...
"""
   ...
   
		{
			...
			"impression": """Mild. Medium to medium-sweet. Still to lightly sparkling. Only very slight acetification is acceptable. Mousiness, ropy/oily characters are serious faults."""
   ...
   
		{
			...
			"impression": """Tannic. Medium to medium-sweet. Still to lightly sparkling. Only very slight acetification is acceptable. Mousiness, ropy/oily characters are serious faults."""
